                        ...
                        <div class="collapse show" id="collapseProductInfo">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="description" style="padding: 50px 12px;" class="form-control" placeholder="Nhập mô tả">

                                    <!-- <div id="ckeditor-classic" name="description" aria-placeholder="Nhập mô tả...">
                                    </div> -->
                                </div>
                            </div>
                        </div>
